...
window.qhly_import(function(lib, game, ui, get, ai, _status){
    game.qhly_initShoushaView = function (name, view, page, cplayer) {
        ...
        if (lib.config.qhly_lutouType && lib.config.qhly_lutouType == 'shousha2') 
          subView.avatar.classList.add('shousha2');
        ...
        subView.backborder = ui.create.div('.qh-back-border',view);
        ...
        subView.page = {
          ...
          skin: {
            ...
            refreshAfterGot: function (name, state) {
              ...
              if (this.firstRefresh) {
                ...
                for (var i = 0; i < this.skinList.length; i++) {
                  ...
                  if (lib.config.qhly_lutouType && lib.config.qhly_lutouType == 'shousha2') skinView.classList.add('shousha2');
                      ...
                      game.qhly_setCurrentSkin(name, originSkin, function () {
                        if (now.belowText.innerHTML != '经典形象') {
                          ...
                          if ((!lib.config.qhly_skinset.djtoggle[name] || lib.config.qhly_skinset.djtoggle[name] && !lib.config.qhly_skinset.djtoggle[name][now.belowText.innerHTML]) && window.decadeUI && decadeUI.dynamicSkin && decadeUI.dynamicSkin[name] && Object.keys(decadeUI.dynamicSkin[name]).contains(now.belowText.innerHTML)) {
                            game.qhly_changeDynamicSkin(state.mainView.avatarImage, now.belowText.innerHTML, name);/*删除名字以取消底部文字*/
            ...
            init: function (name, state) {
              ...
              if (lib.config.qhly_lutouType && lib.config.qhly_lutouType == 'shousha2') dialog.classList.add('shousha2');
              ...
              function conversion1(){
                if(isMovingRight){
                  ...
                  subView.avatar.setAttribute('style','rigth:59%;top: calc(6.5%);');
                  subView.hp.setAttribute('style','display:block;');
                  subView.hpborder.setAttribute('style','opacity:1;');
                  subView.avatarImage.addEventListener("dblclick", variation);
...
        /*以下为新加代码*/
        ...
        var Health = subView.hp;
        var Health_border = subView.hpborder ;
        var shenfen = subView.skinType ;
         subView.avatarImage.addEventListener("dblclick", variation);
        var abo = true;
        function variation(){
            if(abo){  
            state.mainView.avatarImage.setAttribute('style', 'width:calc(257.4%); height: calc(95%)');
            Health.setAttribute('style', 'left:86.3%');
            Health_border.setAttribute('style', 'left:86.1%');
            shenfen.setAttribute('style','display:none');
            subView.rank.setAttribute('style', 'left: 118%;');
            subView.skinRank.setAttribute('style', 'right:-151% ');
            subView.hpWrap.setAttribute('style','right:-46%;');
            subView.bigwrapborder.setAttribute('style','display:none');
            conversion.style.display = 'none';
            abo = false;
          }else if(!abo){
            state.mainView.avatarImage.setAttribute('style', 'width:calc(99%);height: calc(93%);');
            Health.setAttribute('style', 'left:41.8%');
            Health_border.setAttribute('style', 'left:41.6%');
            shenfen.setAttribute('style','display:block');
            subView.rank.setAttribute('style', 'left: 38%;');
            subView.skinRank.setAttribute('style', 'right:1% ');
            subView.hpWrap.setAttribute('style','right:38%;');
